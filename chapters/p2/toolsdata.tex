...
Another source: \url{http://www.envirocloud.se/52n-sos-webapp/service?service=SOS&version=1.0.0&request=GetCapabilities} from the Swedish Environmental Research Institute.
