...
To prevent broken links \ac{purl} are being used. 
...
\begin{lstlisting}[caption={A GeoSPARQL query to find the name of features that contain a point geometry}, label={lst:GeoSPARQL}]
