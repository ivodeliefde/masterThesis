...
%\section{Societial relevance}

%\section{Economic potential}
...
Subquestions:
\begin{itemize}
	\item To what extent can sensor metadata be automatically retrieved from any SOS?
	\item To what extent can sensor metadata from a SOS be automatically converted to linked data and published on the semantic web?
