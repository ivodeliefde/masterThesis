...
\ac{swe} contains the following standards: \ac{om}, \ac{sensorml}, \ac{sos}, sensor planning service, etc. 
The \ac{om}, \ac{sensorml} and \ac{sos} are three very important standards for this thesis and will therefore be described in more detail.

\subsection{Observation and measurements}

How is an observation modelled in \ac{om}?

Explain the following concepts: observation, result time, phenomenon time, result, \ac{uom}, feature of interest
